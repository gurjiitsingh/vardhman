...
export default function CategorySliderLightRound() {
  ...
  return (
    <div id="order_now" className="scroll-mt-24 relative max-w-[1700px] mx-auto  px-14 sm:px-6 lg:px-12 mb-12 mt-25">
      {/* Arrows */}
      <button
        onClick={() => scroll("left")}
      ...
      <div
        ref={scrollRef}
        className="flex gap-5 sm:gap-6 overflow-x-auto scroll-smooth snap-x snap-mandatory scrollbar-hide justify-start px-0"
      >
                ...
                >
                  <div
                    className={`${isActive
                      ...
                      : "relative rounded-full overflow-hidden bg-gray-100 shadow-md"
                  ...
                  <span
                    className={`text-center text-[15px] font-semibold leading-snug px-1 ${isActive
                        ? "text-zinc-700"
