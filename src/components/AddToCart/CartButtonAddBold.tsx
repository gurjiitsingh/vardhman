...
const CartButtonAddBold = ({ cartProduct }: { cartProduct: cartProductType }) => {
        ...
        {quantity > 0 ? (
          ...
          <>
            <div className="bg-[#F3F2F0] px-[3px] pt-[1px] pb-[3px]  rounded-lg">
              <button
                onClick={addToCartL}
                className=" w-[150px] px-1 py-1 rounded-lg bg-white font-bold text-[#ff5a85]  text-xl flex items-center justify-center"
              >
                Add to Cart
              </button>
            </div>
...
export default CartButtonAddBold;
