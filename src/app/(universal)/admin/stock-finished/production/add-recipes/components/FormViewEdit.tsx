  ...
  return (
    <div className="min-h-screen bg-[#f6f8fb] p-4 md:p-6">
      <div className="mw-full flex flex-col gap-6">
        ...
        {/* TOP SEARCH */}
<div className="flex gap-2 bg-white rounded-3xl border border-gray-100 shadow-sm p-5 sticky top-4 z-30">

  {/* Icon */}
  <div className="h-14 w-14 shrink-0 rounded-2xl bg-rose-100 flex items-center justify-center">
    <ChefHat
