          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs flex flex-col gap-5">
              ...
              <Button
                ...
                className={`w-full h-11 font-semibold text-sm rounded-xl tracking-wide shadow-xs bg-slate-900 hover:bg-slate-800 text-white transition duration-150 flex items-center justify-center ${isSubmitting ? "opacity-75 cursor-not-allowed" : ""
                  }`}
              >
