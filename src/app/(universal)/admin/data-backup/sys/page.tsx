...
import { uploadCategoriesJSON, uploadProductsJSONSys } from "../../../action/backup/serverActions";
      ...
      <section className="bg-white shadow-md rounded-xl p-6 space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            {/* Product JSON Upload */}
            <form action={uploadProductsJSONSys} className="border rounded-lg p-4 space-y-3">
