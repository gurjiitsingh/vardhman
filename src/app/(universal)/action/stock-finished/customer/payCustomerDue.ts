  ...
  try {
    ...
    await adminDb.runTransaction(async (tx) => {
      ...
      tx.set(ledgerRef, {
        ...
        // ❌ REMOVED dueAmount & creditAmount

        balance: newBalance, // signed
...
//     // 🔥 calculate advance for THIS transaction
...
//   dueAmount: newBalance > 0 ? newBalance : 0,

//   // ✅ FIX HERE
//   creditAmount: advanceCreated,
